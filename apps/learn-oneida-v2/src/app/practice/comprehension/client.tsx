...
export function PracticeComprehensionClient() {
  ...
  return (
    <PageWrapper>
      <SectionHeading level={1}>Comprehension</SectionHeading>

      <Text>Test your listening skills here.</Text>
      ...
      {hasStarted ? (
        <>
          <AnswerCard
            promptText={currentDatum.en}
            answerText={currentDatum.translation}
          />
        ...
        <Flex justify="end">
          <Button
            ...
            onClick={() => {
              setHasStarted(true);
              setIndex(0);
              trackEvent("Started Comprehension", {
                category,
              });
            }}
          >
