...
export function TimesOfDayArticle({ level = 1 }: ArticleProps) {
  ...
  const eveningPhrases = [
    {
      ...
      translation: ["yoʔkaláshʌ", "yoʔkaláshu"],
    },
    {
      en: "when it was evening",
      translation: "tshiyoʔkaláshu",
    },
    {
  ...
  const morningPhrases = [
    ...
    { en: ["early morning", "in the morning"], translation: "astéhtsii̲" },
  ...
  const nightPhrases = [
    ...
    { en: "every night", translation: "yaʔtewahsu·táke" },
    { en: "midnight", translation: "ashú·tha" },
    { en: "(when it got dark) last night", translation: "kwaʔshu·té·" },
    { en: ["this night", "tonight"], translation: "kaʔi·kʌ́· wahsuta·té͟·" },
    { en: "the other night", translation: "oyá· tshitkwaʔshu·té·" },
  ...
  const tomorrowPhrases = [
    ...
    { en: "tomorrow night", translation: ["ʌyólhʌneʔ", "ʌyó·kalaweʔ"] },
    { en: "tomorrow evening", translation: ["ʌyólhʌneʔ", "yoʔkala·sneʔ"] },
  ...
  const weekPhrases = [
    { en: "all week", translation: "yaʔtewʌ·tá·ke" },
  ...
  const yearPhrases = [
    { en: "all year", translation: "ohslakwekú" },
    {
    ...
    { en: "next year", translation: "yʌtsyohslá·teʔ" },
    { en: "the other year", translation: "oyá· tshikohslá·ke̲" },
    { en: "a particular year", translation: "kaʔi·kʌ́· yohsla·té·" },
    { en: "how many years?", translation: "niyohslaké̲" },
    { en: "one year after another", translation: "yohslaténi" },
  ];

  const yesterdayPhrases = [
    { en: "yesterday", translation: "the·tʌ́·" },
    { en: "the day before yesterday", translation: "o·yá tshithe·tʌ́" },
  ];
