...
export default createParadigmData(
  {
    translation: "{{pronoun}} might tidy up",
    type: "PR",
    phrases: [
      {
        breakdown: [["t", "DUAL"], ["a", "IFUT"], ["k"], "atohtálhoʔ"],
      },
      {
        breakdown: [["t", "DUAL"], ["a", "IFUT"], ["hs"], "atohtálhoʔ"],
      },
      {
        breakdown: [["t", "DUAL"], ["a", "IFUT"], ["h"], "atohtálhoʔ"],
      },
      {
        breakdown: [["t", "DUAL"], ["a", "IFUT"], ["yu"], "tohtálhoʔ"],
      },
      {
      ...
      {
        breakdown: [["t", "DUAL"], ["a", "IFUT"], ["ku"], "tohtálhoʔ"],
      },
    ],
  },
  pronouns,
