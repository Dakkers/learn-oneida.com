...
export default createParadigmData(
  {
    translation: "{{pronoun}} am understanding",
    type: "PB",
    phrases: [
      {
      ...
      {
        breakdown: [["waʔ", "DEF"], ["ho"], "ʔnikuhlayʌ·táneʔ"],
      },
      {
        breakdown: [["waʔ", "DEF"], ["yako"], "ʔnikuhlayʌ·táneʔ"],
      },
      {
        breakdown: [["waʔ", "DEF"], ["yo"], "ʔnikuhlayʌ·táneʔ"],
      },
      {
      ...
      {
        breakdown: [["waʔ", "DEF"], ["yoti"], "ʔnikuhlayʌ·táneʔ"],
      },
      {
