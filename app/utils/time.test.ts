...
describe('doTheTranslate()', () => {
  ...
  it.only('should translate 12:23 AM', () => {
    assert.deepEqual(doTheTranslate(0, 23), ['tewáhsʌ áhsʌ nikahí·kalat yotukóhtu ahsútha']);
  });
  ...
  it.only('should translate 12:16 PM', () => {
    assert.deepEqual(doTheTranslate(12, 16), ['yá·yak yawʌ·lé· nikahí·kalat yotukóhtu ʌ́ti']);
  });
  ...
  it.only('should translate 1:00 PM', () => {
    assert.deepEqual(doTheTranslate(13, 0), ['úska niyohwistá·e yotukóhtu ʌ́ti']);
  });
