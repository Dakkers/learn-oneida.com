...
const oneidaToEnglishModule06 = [
  ["1", "Yáh teʔwakekhuní nuʔú·waʔ, yáh náhteʔteʔkatyélhaʔ"],
  ["2", "Tá ·t akenho·tú ·, ʌhsatatewyʌnʌ·tá neʔ kʌ́"],
  ...
  ["7", "Yáh tehakhlolí kanke tshihoyo·té̲́·"],
  ["8", "Wahshakotiyaʔtakénhaʔ akutinhotu·kó"],
  ["9", "Waʔakwatkáhthoʔ né· shakoyoʔokúha tsiʔnahútyele"],
  ["10", "Yá h tehuwayaʔtaké nhʌ latatlihunyʌ·ní heʔ"],
  ...
  ["14", "Satahúhsatat tsiʔnáhteʔ yu·tú·"],
  ["15", "Knú·wehseʔ kʌs katló·loks tsiʔwataʔklókwas"],
];
