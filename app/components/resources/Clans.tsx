...
export function ClansResource({ level = 1 }: {
  level?: 1 | 2;
}) {
  return (
    <Flex direction="column" gap={4}>
      ...
      <Text>
        Here, you can learn about clan animals and how to say someone is from a clan.
        The clans in Oneida are: bear, turtle, and wolf.
      </Text>
